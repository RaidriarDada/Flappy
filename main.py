...
def flappygame():
    ...
    down_pipes = [
        {'x': window_width + 100 - mytempheight,
         'y': first_pipe[1]['y']},
        {'x': window_width + 100 - mytempheight + (window_width / 1.5),
         'y': second_pipe[1]['y']},
    ]
    ...
    while True:
        ...
        # Lets bulid our game images now
